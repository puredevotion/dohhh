...
export const AUTOIMMUNE: CategoryContent = {
  bscba: [
    ...
    [
      ...
      0,
      'Reumatoïde artritis wordt gekenmerkt door chronische, destructieve gewrichtsontsteking door immuunaanval, terwijl de andere opties infecties zijn veroorzaakt door specifieke pathogenen.',
    ],
    [
    ...
    [
      ...
      0,
      'Glutenpeptiden worden bij gevoelige personen gewijzigd en aan immuuncellen gepresenteerd, wat een aanval op de wand van de dunne darm uitlokt die nutriëntabsorptie verstoort.',
    ],
    [
      'Multiple sclerose wordt gekenmerkt door immuunaanval op welk onderdeel van zenuwvezels?',
      ['De myelineschede die zenuwsignalen isoleert en versnelt', 'De zenuwcellichamen in de hersenen', 'Spiercellen', 'De spinale vloeistof'],
      0,
    ...
    [
      ...
      ['Biologische therapieën die belangrijke ontstekingscytokinen blokkeren', 'Antibiotica die ziekteverwekkende pathogenen doden', 'Hormoonsuppletie', 'Alleen vitamineolie'],
      0,
    ...
    [
      ...
      0,
      'De overgrote meerderheid van mensen met spondylitis ankylopoetica draagt HLA-B27, hoewel de meeste dragers de ziekte nooit ontwikkelen, wat aantoont dat het een risicofactor is.',
    ],
    [
    ...
    [
      ...
      0,
      'De ziekte van Crohn veroorzaakt transmurale ontsteking (door alle lagen van de darmwand heen) overal in het spijsverteringskanaal, van mond tot anus, wat contrasteert met colitis ulcerosa.',
    ],
    [
      'Het syndroom van Sjögren veroorzaakt klassiek welk symptomenpaar door auto-immune schade aan bepaalde klieren?',
      ['Droge ogen en droge mond door lymfocytische infiltratie van traan- en speekselklieren', 'Overmatig zweten en koorts', 'Gewichtstoename en koude-intolerantie', 'Gewrichtszwelling en spierzwakte'],
      0,
  ...
  msc: [
    ...
    [
      ...
      ['Droge ogen en een droge mond', 'Alleen gewrichtspijn en koorts', 'Gewichtstoename en koude-intolerantie', 'Huidverdikking en het fenomeen van Raynaud'],
      0,
  ...
  professor: [
    ...
    [
      ...
      0,
      'De drieledige histologische bevinding en verhoogde aantallen IgG4+ cellen maken het mogelijk om voorheen ongerelateerde aandoeningen als één ziektebeeld te herkennen.',
    ],
    [
...
export const OBGYN: CategoryContent = {
  bscba: [
    ...
    [
      ...
      0,
      'Progesteron verdikt het baarmoederslijmvlies en onderhoudt het; dit is nodig voor innesteling als bevruchting plaatsvindt, of het wordt afgestoten als zwangerschap niet optreedt.',
    ],
    [
    ...
    [
      ...
      0,
      'Buitenbaarmoederlijke zwangerschappen kunnen zich niet normaal ontwikkelen en vormen voor de moeder een ernstig risico op ruptuur en bloeding.',
    ],
    [
      'Zwangerschapsdiabetes treedt op wanneer wat zich in de zwangerschap ontwikkelt?',
      ['Insulineresistentie door placentahormonen, wat tot verhoogde bloedglucose leidt', 'Vernietiging van de pancreas voorafgaand aan de zwangerschap', 'Afwezigheid van enige pancreasbètacel', 'Overmatige insulineproductie door de foetus'],
      0,
    ...
    [
      ...
      ['Falen van de baarmoeder om na de bevalling goed samen te trekken', 'Alleen achtergebleven placenta', 'Alleen scheuren in het geboortekanaal', 'Alleen maternale bloedingsstoornissen'],
      0,
      'De baarmoeder trekt normaal na de bevalling samen om bloedvaten dicht te knijpen; inadequate samentrekking (atonie) kan de bloeding niet stelpen, wat de voornaamste oorzaak van levensbedreigend maternaal bloedverlies is.',
    ],
    [
    ...
    [
      ...
      0,
      'De 12-maanden-drempel weerspiegelt de volledige stopzetting van de ovariële functie en hormoonproductie, wat menopauze onderscheidt van perimenopauze.',
    ],
    [
      ...
      0,
      'Uiterlijk, Pols, Grimasreflex, Activiteit/tonus en Ademhaling worden elk gescoord van 0-2, wat een snelle beoordeling geeft van of de pasgeborene onmiddellijke hulp nodig heeft.',
    ],
    [
      ...
      0,
      'Fibromen zijn hormoongevoelig en groeien in de vruchtbare jaren, wat dikwijls zwaar bloedverlies en bekkendruk veroorzaakt, hoewel veel symptoomloos zijn.',
    ],
    [
  ...
  professor: [
    ...
    [
      ...
      0,
      'hCG-afscheiding maakt betrouwbare monitoring van de chemotherapierespons mogelijk, met een hoge genezingskans zelfs bij uitgezaaide ziekte.',
    ],
    [
...
export const DUTCH: CategoryContent = {
  bscba: [
    ...
    [
      'De gebeurtenis die in 1672 het "Rampjaar" wordt genoemd, betrof wat?',
      ...
      0,
      'Deze militaire crisis, toen meerdere vijanden van verschillende richtingen binnenvielen, dreigde bijna de Republiek te vernietigen en leidde tot de val van het regime van de handelsrepubliek.',
    ],
    [
    ...
    [
      ...
      ['De Tachtigjarige Oorlog onderbrak, waardoor beide zijden de kans kregen zich te consolideren voordat de strijd werd hervat', 'De oorlog permanent beëindigde met Spanje', 'De Nederlanden met Spanje onder één kroon verenigde', 'Het stadhouderschap permanent afschafte'],
      0,
      'Zowel Spanje als de Republiek staakten de strijd vanwege uitputting en financiële druk, al laaiden de vijandelijkheden weer op toen het bestand afliep.',
    ],
    [
    ...
    [
      ...
      ['De vroegere Nederlandse Republiek en de Zuidelijke Nederlanden (ongeveer het huidige België)', 'De Nederlanden en Luxemburg alleen', 'De Nederlanden en Vlaanderen', 'De Nederlanden en alle Duitse landen'],
      0,
    ...
    [
      ...
      ['Religieuze en taalkundige spanningen tussen katholiek zuiden en protestant-gedomineerd noorden', 'Een handelsgeschil alleen over de VOC', 'Onenigheid over marinebeleid alleen', 'Een opvolgingscrisis na de dood van de koning'],
      0,
    ...
    [
      'De Engels-Nederlandse Oorlogen van de 17e eeuw werden vooral uitgevochten over wat?',
      ...
      0,
      'Engeland en de Nederlandse Republiek concurreerden fel om scheepsroutes en overzeese handelsposten, waarbij marinegevechten de drie conflicten tussen 1652 en 1674 bepaalden.',
    ],
    [
    ...
    [
      'De grondwetshervorming van 1848 onder Johan Rudolph Thorbecke bereikte vooral wat?',
      ['Verschuiving van de Nederlanden naar constitutionele monarchie met sterker parlementair gezag', 'Afschaffing van de monarchie volledig', 'Herstel van absoluut koningsgezag', 'Hereniging van de Nederlanden en België'],
      0,
      'De hervormingen van Thorbecke beperkten de koninklijke autoriteit doordat ministers voortaan verantwoording verschuldigd waren aan een gekozen parlement, wat het Nederlandse bestuur moderniseerde.',
    ],
  ],
  msc: [
    [
  ...
  phd: [
    ...
    [
      ...
      0,
      'De Glorious Revolution maakte Willem III dubbele vorst-stadhouder en stemde het Nederlandse en Engelse beleid tegen Lodewijk XIV op elkaar af.',
    ],
    [
      ...
      0,
      'Patriotten wilden de macht van Willem V beteugelen en de burgerlijke politieke macht uitbreiden; Pruisische interventie herstelde het Oranjegezag in 1787.',
    ],
    [
  ...
  professor: [
    ...
    [
      ...
      0,
      'Wrok tegen belastingpachters escaleerde tot oproer en een roep om Willem IV als stadhouder aan te stellen - een fiscaal-politieke grief.',
    ],
    [
    ...
    [
      ...
      0,
      'De Republiek leek de "algemene crisis" van Europa halverwege de 17e eeuw te weerstaan dankzij haar handelsgedreven economie.',
    ],
    [
    ...
    [
      ...
      0,
      'Willem II sloeg in 1848 om van conservatief naar liberaal en gaf persoonlijk opdracht tot Thorbeckes hervormingen, waarmee geweld werd vermeden.',
    ],
    [
      ...
      0,
      "Bijeengeroepen na de plotselinge dood van Willem II, waardoor zijn erfgenaam nog een kind was, slaagden afgevaardigden van alle zeven provincies er niet in overeenstemming te bereiken over een stadhouder voor Holland - hoewel verscheidene andere provincies er wel een benoemden - en juist dit uitblijven van een besluit luidde het Eerste Stadhouderloze Tijdperk en de opkomst van De Witt in.",
    ],
  ],
};
...
export const MAKER: CategoryContent = {
  bscba: [
    ...
    [
      ...
      ['Extrusie-, hars- en poedergebaseerde methoden', 'Alleen kunststof-, metaal- en keramiekmethoden', 'Handmatig, automatisch en mechanisch methoden', 'Kleur-, zwart-wit en grijsschaalmethoden'],
      0,
    ...
    [
      ...
      ['PLA, vanwege lage afdruktemperatuur en minimaal vervormen', 'ABS, wat het beste afdrukt bij de laagste temperaturen', 'Koolstofvezelcomposiet, wat het makkelijkst afdrukt', 'Nylon, het gemakkelijkste materiaal om af te drukken'],
      0,
      'Polymelkzuur (PLA) is afgeleid van plantaardige bronnen, drukt af bij lage temperatuur, geeft minder rook en vervormt minder dan materialen als ABS.',
    ],
    [
      'Wat is "infill" bij 3D-printen?',
      ['De binnenstructuur van een object dat anders hol zou zijn gedrukt', 'De buitenste laag van het geprinte object', 'Steunmateriaal onder overhangen', 'Het platform waarop het onderdeel drukt'],
      0,
      'In plaats van overal massieve kunststof te gebruiken, krijgt het interieur een lichtgewicht roosterpatroon met een gekozen dichtheidspercentage, wat sterkte in evenwicht brengt met afdrukduur en materiaalgebruik.',
    ],
    [
      'Waarvoor worden lasersnijders vooral gebruikt?',
      ['Materialen snijden en graveren door ze te verdampen met een gefocuste laserstraal', 'Metalen platen aan elkaar lassen', 'Oppervlakken naar glans polijsten', 'Objecten verwarmen zonder te snijden of te graveren'],
      0,
    ...
    [
      'Vezellasers worden over het algemeen geprefereerd voor welke toepassing?',
      ['Snijden en graveren van metaal', 'Acrylplaten snijden', 'Hout met detail graveren', 'Papier en karton snijden'],
      0,
      'Vezellasers zenden een kortere golflengte uit die metalen efficiënt absorberen, wat ze standaard maakt voor industrieel metaalsnijden en markeerwerk.',
    ],
    [
      ...
      0,
      'Als de eerste laag niet goed hecht, kan het verschuiven of losraken, wat de volledige afdruk doet mislukken; bedadhesie krijgt veel aandacht om deze reden.',
    ],
    [
    ...
    [
      'Waarom is ventilatie of rookafvoer belangrijk bij lasersnijden?',
      ['Snijden van veel materialen geeft giftige rook en dampen af die schadelijk zijn om in te ademen', 'Om alleen de laserbuis af te koelen', 'Om elektrostatische opbouw te voorkomen', 'Om de snijsnelheid van de machine te verbeteren'],
      0,
    ...
    [
      ...
      ['Een poedergebaseerd proces waarbij een laser poederdeeltjes laag voor laag aan elkaar smelt', 'Een extrusiegebaseerd proces identiek aan FDM', 'Een harsuithardingsproces hetzelfde als SLA', 'Een handmatige laagstapeltechniek'],
      0,
      'Een laser sintert selectief poederdeeltjes samen, bouwt het onderdeel op terwijl ongesinterd poeder steun biedt; veel gebruikt voor nylon en andere geëngineerde materialen.',
    ],
  ],
  msc: [
    [
      'Hoe werkt FDM (Fused Deposition Modelling) 3D-printen in essentie?',
      ['Thermoplastisch filament wordt gesmolten en laag voor laag geëxtrudeerd', 'Vloeibare hars wordt uitgehard met ultraviolet licht', 'Metaalpoeder wordt met een laser gesinterd', 'Materiaal wordt in lagen gesneden uit een vaste plaat'],
      0,
  ...
  phd: [
    ...
    [
      ...
      0,
      'Binder jetting-onderdelen zijn "groen" totdat ze in een oven worden gesinterd, wat ze dichter en sterker maakt.',
    ],
    [
      ...
      0,
      'Q-switching laat energie opbouwen en geeft die vervolgens snel vrij, wat zeer hoge piekvermogens oplevert voor lasermarkering en tattooverwijdering.',
    ],
    [
    ...
    [
      ...
      0,
      'Te lage nozzeltemperatuur of onvoldoende koeling verhindert versmelting tussen lagen, wat zwakke hechting en loslaten veroorzaakt.',
    ],
    [
  ...
  professor: [
    ...
    [
      ...
      0,
      'Warme onderste lagen worden samengedrukt door bovengelegen lagen, wat bolling veroorzaakt (niet optillen of kromtrekken).',
    ],
    [
    ...
    [
      ...
      0,
      'Losraakkrachten bij grote platte doorsnedes kunnen vervorming of scheuren veroorzaken; schuin oriënteren werkt beter.',
    ],
    [
      ...
      0,
      'Laserdiodes hebben hoger rendement dan flitslampen en langere levensduur, wat de opkomst van DPSS-lasers sinds de jaren negentig aandreef.',
    ],
    [
      ...
      0,
      'M2 = 1 is perfect diffractie-gelimiteerd; bij reële lasers is M2 > 1, wat het focusserend vermogen voor snijden beïnvloedt.',
    ],
    [
      ...
      0,
      'Het Marangoni-effect en oppervlaktespanning kunnen het smeltbad doen uiteenvallen in bolletjes bij suboptimale parameters.',
    ],
    [
    ...
    [
      ...
      0,
      'Femtoseconde-pulsenergie wordt sneller afgezet dan de warmte kan wegvloeien, wat koude ablatie met minimale thermische schade mogelijk maakt.',
    ],
    [
