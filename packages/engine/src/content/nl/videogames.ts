...
export const VIDEOGAMES: CategoryContent = {
  bscba: [
    [
      'Het Nintendo Entertainment System voorkwam dat niet-gelicentieerde games liepen door een speciale authenticatiechip. Welk primair industrieprobleem beoogde dit systeem op te lossen?',
      ['Te veel games van lage kwaliteit van derden die de markt overspoelden na de crash van 1983', 'Cartridges die illegaal werden gekopieerd en als vervalsingen verkocht', 'Spelers die cartridges tussen meerdere consoles deelden', 'Spelbouwers die onredelijk hoge prijzen voor cartridges rekenden'],
      0,
      'Na de marktinstorting van 1983 vanwege overproductie van slechte games op concurrerende systemen, gebruikte Nintendo de 10NES-chip voor strikte licentiecontrole van derden, waardoor marktkwaliteit werd gehandhaafd.'
    ],
    [
      'Sega marketingde de Genesis-console intensief begin jaren negentig met de term "Blast Processing." Welk hardwarekenmerk verwees deze slogan naar?',
      ['Snelle gegevensoverdracht naar de grafische processor voor snelle schermupdate', 'Een tweede CPU die twee keer zo snel loopt als de hoofdprocessor', 'Een speciale chip gewijd aan 3D-polygoonrendering', 'Een propriëtair geheugen dat fundamenteel sneller was'],
      0,
    ...
    [
      ...
      ['Cartridges boden sneller laden en betere anti-piraterijbescherming', 'CD-ROM\'s waren te duur voor Nintendo om te vervaardigen', 'Nintendo had niet de technologie om CD-ROM-stations te laten werken', 'Cartridges konden meer gegevens opslaan dan CD-ROM\'s van die tijd'],
      0,
      'Cartridges boden bijna onmiddellijk laden met minimale vertraging en waren veel moeilijker te piraten dan CD\'s. Deze keuze betekende echter dat de N64 veel minder opslagcapaciteit had dan concurrerende consoles.'
    ],
    [
      'De Sega Dreamcast, gelanceerd in 1998-1999, viel op door het opnemen van welke standaardfunctie die de meeste andere consoles alleen als optionele toevoeging aanboden?',
      ['Een ingebouwde modem voor internetverbinding', 'Ondersteuning voor meerdere controllers tegelijk', 'Een ingebouwde FM-synthesegeluidschip', 'Achterwaartse compatibiliteit met eerdere Sega-consoles'],
      0,
      'Elke Dreamcast werd geleverd met een ingebouwde 56k-modem, zodat eigenaars onlinegames als Phantasy Star Online konden spelen zonder aparte hardware te kopen, wat hem van concurrenten onderscheidde.'
    ],
    [
      'Voordat het Sony\'s zelfstandige PlayStation-console werd, begon het project als gezamenlijke ontwikkeling met welk bedrijf als CD-ROM-toevoeging voor hun bestaande console?',
      ['Nintendo', 'Sega', 'Atari', 'NEC'],
      0,
      'Sony werkte eind jaren tachtig/begin jaren negentig met Nintendo samen aan een CD-ROM-toevoeging voor de Super Nintendo, maar Nintendo onderhandelde tegelijkertijd met Philips en verraste Sony in 1991 publiekelijk, wat Sony aanzette de PlayStation zelfstandig te lanceren.'
    ],
    [
      'De originele Game Boy had een relatief eenvoudige, energiezuinige processorontwerp vergeleken met kleurrijkere concurrerende handhelds. Wat was de primaire reden voor deze ontwerkkeuze?',
      ['De batterijduur op AA-batterijen maximaliseren', 'Het apparaat goedkoop genoeg maken voor massa-marktconsumenten', 'Compatibiliteit met toekomstige Game Boy-versies garanderen', 'Spelbouwing voor het platform vereenvoudigen'],
      0,
      'De bescheiden hardware van Game Boy werd bewust gekozen om veel uren op vier AA-batterijen te draaien, terwijl flitsendere concurrenten als Atari Lynx en Game Gear batterijen veel sneller leeggooiden.'
    ],
    [
      'De Magnavox Odyssey wordt algemeen erkend als de eerste commerciële thuisvideogameconsole. In welk jaar werd het uitgebracht?',
      ['1972', '1975', '1969', '1977'],
      0,
    ...
    [
      'De grafiek van de originele PlayStation vertoonde vaak een visueel artefact waarbij texturen op polygonen leken te buigen of vervormen. Hoe werd deze technische beperking genoemd?',
      ['Textuurbvervorming door affiene textuurmapping', 'Aliasing-artefacten van interlaced rendering', 'Z-fighting tussen overlappende oppervlakken', 'Mip-mapniveaubanden-artefacten'],
      0,
      'De PS1-GPU gebruikte affiene textuurmapping zonder perspectiefcorrectie, wat tekstuurvervorming op grote of schuine polygoonoppervlakken veroorzaakte. Dit werd een herkenbaar kenmerk van de visuele stijl van de console.'
    ],
    [
      'Wat was de primaire reden dat Nintendo besloot de beeldscherm van de Virtual Boy monochroom rood te houden in plaats van volledige kleurafbeeldingen aan te bieden?',
      ['Rode LED\'s en spiegels gebruiken was goedkoper dan kleur-LCD-panelen maken', 'Rood licht veroorzaakt minder oogvermoeidheid bij langdurig spelen', 'Monochrome beeldschermen waren gemakkelijker voor de ogen om te verwerken', 'Kleur-LCD-technologie was niet beschikbaar in 1995'],
      0,
      'De Virtual Boy gebruikte een ingenieus maar goedkoop LED- en oscillerend spiegelsysteem voor elk oog. Alleen rode LED\'s gebruiken was goedkoper dan dual kleur-LCD-panelen voor de stereoscopische resolutie die Nintendo wilde.'
    ],
    [
      'De Sega Master System was in de Verenigde Staten en Europa niet succesvol, maar bereikte langtermijn-marktdominantie in één land dankzij een partnerschap met een lokaal bedrijf. Welk land?',
      ['Brazilië', 'Mexico', 'Zuid-Korea', 'Argentinië'],
      0,
      'Een Braziliaans bedrijf genaamd Tectoy licentieerde de Master System vanaf 1989 voor hun markt en vervaardigde en bracht games decennialang uit nadat Sega elders verder ging, domineerde de lokale markt.'
    ],
    [
      'De PC Engine (TurboGrafx-16) werd met "16-bit"-branding op de markt gebracht ondanks een 8-bits CPU. Waar verwees de "16-bit"-aanduiding werkelijk naar?',
      ['De grafische processor die intern met 16-bits gegevens werkte', 'De breedte van de hoofdprocessorbus tussen CPU en RAM', 'De adresruimtegrootte van cartridge-ROM', 'De geluidssynthesechip van Yamaha'],
      0,
      'NEC\'s marketing leunde op de 16-bits interne werking van de grafische chip om tegen echte 16-bits machines als Genesis en SNES te concurreren, hoewel de CPU zelf een 8-bits ontwerp afgeleid van de 6502-familie was.'
    ],
    [
      'Doom (1993) was revolutionair omdat het welk type bestand populair maakte dat spelers konden maken en delen om het spel buiten de originele inhoud uit te breiden?',
      ['Aangepaste kaarten en spelwijzigingen (mods)', 'High-definition textuurbundels voor grafische upgrades', 'Netwerkprotocoluitbreidingen voor onlinespel', 'Emulatie-cores voor uitvoering op verschillende hardware'],
      0,
      'id Software ondersteunde officieel Doom-modificaties en aangepaste kaarten, wat een bloeiende modding-gemeenschap tot stand bracht die nieuwe niveaus en spelvarianten creëerde. Dit werd standaardpraktijk voor pc-games daarna.'
    ],
    [
  ...
  msc: [
    ...
    [
      ...
      0,
      'De videoprocessor van de Genesis gebruikte DMA om delen van het scherm snel tussen beeldbeurten te vernieuwen. Sega\'s marketingteam verpakte deze bestaande functie in de term "Blast Processing" — pakkend, maar technisch vaag.',
    ],
    [
    ...
    [
      ...
      0,
      'Nintendo gaf Sony opdracht een cd-rom-uitbreiding en SNES-compatibel cartridgeformaat te bouwen genaamd "Play Station", maar onderhandelde tegelijk een rivaliserende cd-deal met Philips en overviel Sony daarmee publiekelijk op de CES van 1991.',
    ],
    [
      ...
      0,
      'John Carmack gebruikte BSP-bomen om levelgeometrie vooraf te structureren voor snelle doorloop, zodat wanden in de juiste dieptevolgorde werden getekend zonder depth buffer. Essentieel voor pc\'s van begin jaren negentig zonder per-pixel dieptetests.',
    ],
    [
    ...
    [
      ...
      0,
      'System 16 combineerde een Motorola 68000 als hoofdprocessor met een toegewijde Z80 voor het geluid, een gangbare taakverdeling in arcadehardware van die tijd.',
    ],
    [
      'Atari bracht de Jaguar (1993) op de markt als \'s werelds eerste "64-bits" console, een claim die breed werd betwist omdat de daadwerkelijk besturende processor, een Motorola 68000, gegevens maar met welke breedte verwerkte, terwijl het cijfer "64-bit" verwees naar een gecombineerde busbreedte over afzonderlijke aangepaste coprocessoren?',
      ['16/32-bit', '8-bit', '64-bit (de claim klopte)', '128-bit'],
      0,
      'De 68000 van de Jaguar deed vooral opstart- en beheertaken, terwijl twee aangepaste chips ("Tom" en "Jerry") de grafische en audioverwerking deden. Atari\'s "64-bit"-claim kwam van opgetelde interne busbreedtes, niet van een processorregister.',
    ],
    [
    ...
    [
      ...
      ['Brazilië', 'Mexico', 'Zuid-Korea', 'Argentinië'],
      0,
      'Tectoy nam vanaf 1989 de licentie op de Master System voor Brazilië en bleef ongewoon lang, decennialang, nieuwe games produceren en uitbrengen nadat Sega elders al was doorgegaan, met regiospecifieke titels die nergens anders zijn uitgekomen.',
    ],
  ],
  phd: [
    [
      ...
      0,
      'Sega combineerde twee Hitachi SH-2-processoren in de hoop dat ontwikkelaars taken konden verdelen, maar dit vereiste zorgvuldige handmatige planning waar veel westerse studio\'s mee worstelden. Japanse interne teams als AM2 behaalden veel betere resultaten.',
    ],
    [
      ...
      0,
      'Trip Hawkins verliet EA om in 1991 The 3DO Company te starten, met een VHS-achtig licentiemodel: 3DO ontwierp de specificaties, en partners als Panasonic produceerden de apparaten onder eigen merk. Dat bespaarde productiekosten, maar liet niemand de prijs strak beheersen.',
    ],
    [
      ...
      0,
      'SGI, bekend van professionele high-end 3D-grafische workstations, werkte samen met Nintendo om die rendering-expertise te vertalen naar betaalbare consumentenchips voor de N64, wat het geavanceerde textuurfiltering en anti-aliasing gaf voor 1996.',
    ],
    [
      ...
      0,
      'Het real-time streamen en decomprimeren van cd-data, plus sprite-schaling en rotatie, vergde meer rekenkracht dan Sega van de oorspronkelijke 68000 van de Genesis wilde vragen, dus voegden ingenieurs een tweede, snellere 68000 toe die die extra belasting afhandelde.',
    ],
    [
      ...
      0,
      'Elk oogstuk had een rij rode leds en een oscillerende spiegel die licht liet zwaaien om via persistence-of-vision een beeld te vormen, goedkoper dan twee lcd-panelen. Nadelen: alleen monochroom rood-zwart, enkel tafelgebruik en veel gemelde oogvermoeidheid.',
    ],
    [
      ...
      0,
      'De GPU interpoleerde textuurcoördinaten lineair over het scherm in plaats van correct in 3D-perspectiefruimte, waardoor texturen op grote of schuine polygonen leken te buigen, zwemmen of wiebelen zodra de camera bewoog, vooral zichtbaar op grondvlakken.',
    ],
    [
    ...
    [
      ...
      0,
      'De CD32 hergebruikte de AGA-chipset van de Amiga 1200 voor betere kleuren en resolutie, zonder nieuwe grafische chips te ontwikkelen. Bestaande Amiga-games konden zo met weinig aanpassing worden overgezet, tegen een prijs die kon concurreren met 3DO en Sega CD.',
    ],
    [
    ...
    [
      'De arcadeversie van Rare en Midway\'s Killer Instinct (1994) draaide op hardware gebouwd rond een processor uit de MIPS-familie, afgeleid van Silicon Graphics-workstationtechnologie, een ongewoon krachtige en dure keuze voor een arcadevechtgame uit die tijd. Tot welke algemene processorfamilie behoorde deze chip?',
    ...
    [
      ...
      0,
      'NEC en Hudson Soft zetten in op FMV en visuele-novelle-content, populair op Japanse pc\'s, als de sterke kant van de PC-FX, en optimaliseerden de hardware voor snelle videodecompressie in plaats van 3D-geometrie.',
    ],
    [
  ...
  professor: [
    [
      'Magnavox\'s patentinbreukzaak uit 1974 tegen Atari over de onderliggende technologie van de Odyssey — de eerste in een lange reeks rechtszaken die Magnavox won tegen bijna de gehele industrie — was gebaseerd op patenten die oorspronkelijk waren aangevraagd door welke ingenieur, later "de vader van de thuisvideogame" genoemd?',
      ['Ralph Baer', 'Nolan Bushnell', 'Al Alcorn', 'Bill Rusch'],
      0,
      'Ralph Baer schetste vanaf 1966 bij Sanders Associates concepten voor interactieve tv-spellen; zijn patenten, gelicentieerd aan Magnavox, dekten ideeën als door de speler bestuurde stippen die op het scherm interageerden — breed genoeg om vrijwel elke latere console te omvatten, inclusief Atari\'s.',
    ],
    [
    ...
    [
      ...
      0,
      'Radar Scope flopte bij de Amerikaanse release in 1980, waardoor Nintendo\'s Amerikaanse dochteronderneming bleef zitten met circa 2000 onverkochte kasten en grote financiële druk. Het bedrijf gaf Shigeru Miyamoto de opdracht een nieuw spel te maken dat de bestaande hardware kon hergebruiken.',
    ],
    [
      ...
      0,
      'Zaxxon toonde ruimtevestingomgevingen vanuit een vaste diagonale boven-hoek en gebruikte schaduwen onder het ruimteschip om hoogte weer te geven, wat vliegen simuleerde zonder echte 3D-geometrie.',
    ],
    [
      ...
      0,
      'De Special Chip functioneerde als een vroege hardware-blitter, die snel blokken pixelgegevens kopieerde en verplaatste zonder dat de hoofdprocessor alles opnieuw moest tekenen, waardoor Robotron: 2084 tientallen onafhankelijk bewegende vijanden tegelijk op het scherm kon tonen.',
    ],
    [
      'Coleco\'s ADAM-computer (1983), verkocht als uitbreiding op de ColecoVision, had een beruchte ontwerpfout: de opstartstroomstoot van de printer, nodig om het hele gecombineerde systeem van stroom te voorzien, kon gegevens wissen op welk opslagmedium als er tijdens het opstarten toevallig een bandje in het station lag?',
      ...
      0,
      'De ADAM kreeg stroom via de meegeleverde daisywheel-printer in plaats van een losse adapter, en de stroomstoot bij het opstarten kon Digital Data Pack-bandjes in het station beschadigen. Een beruchte ontwerpfout die de al problematische lancering nog verergerde.',
    ],
    [
      ...
      0,
      'CPS-2-bordjes versleutelden de programma-ROM\'s en hadden een batterijgebufferde beveiligingsmodule nodig om de code tijdens gebruik te decoderen. Zodra de batterijen na jaren leegraakten, viel het bordje volledig uit in plaats van door te blijven werken — een bewuste afweging tegen piraterij.',
    ],
    [
      ...
      0,
      'De aangepaste videohardware van de X68000 bevatte toegewijde sprite- en achtergrondscroll-circuits die qua vermogen leken op Capcom-arcadebordjes, waardoor programmeurs opvallend nauwkeurige poorten konden maken, jaren voordat betaalbare consoles dat konden evenaren.',
    ],
    [
      ...
      ['Zes', 'Vier', 'Twee', 'Tien'],
      0,
      'MVS-kasten waren er in configuraties met één, twee, vier of zes sleuven. Met zes sleuven konden uitbaters een roulerend aanbod van games bieden en zwakke titels wisselen zonder nieuwe hardware aan te schaffen — efficiënt bij beperkte vloerruimte.',
    ],
    [
      ...
      0,
      'Model 2 gebruikte 3D-technologie die oorspronkelijk was ontwikkeld voor militaire vluchtsimulatoren, voortgezet via Real3D, een joint venture met de geavanceerde graphics-divisie van Lockheed Martin, waardoor luchtvaartwaardige real-time 3D jaren voor thuisconsoles in arcadehallen belandde.',
    ],
    [
      ...
      0,
      'De kroegbaas belde Atari om te melden dat de machine niet meer werkte, maar toen een technicus de kast opende, bleek de muntenbak volledig vastgelopen door de hoeveelheid kwartjes — het spel was zo populair dat het geld sneller binnenstroomde dan verwacht.',
    ],
    [
      ...
      0,
      'Pinky\'s AI berekent een doeltegel precies vier vakjes voor Pac-Man in zijn kijkrichting en beweegt daar vervolgens naartoe. Alle vier de geesten gebruiken dezelfde onderliggende logica, maar berekenen verschillende doelen, wat elk een eigen karakter geeft.',
    ],
    [
      ...
      0,
      'De originele kast van Darius, de "Body Sonic"-editie, koppelde drie afzonderlijke crt-monitoren naadloos aan elkaar tot één doorlopend panoramisch speelveld — een indrukwekkende en dure presentatie die grote bossgevechten meer impact moest geven.',
    ],
    [
      ...
      0,
      'De aangepaste hardware van Out Run schaalde sprite-graphics per beeldlijn in real time, waardoor objecten langs de weg groter of kleiner werden naarmate de auto van de speler naderde, wat snelheid en diepte simuleerde zonder echte 3D-geometrie.',
    ],
    [
      'Atari\'s Battlezone (1980), een arcade-tankspel met vectorgrafiek, werd voor het Amerikaanse leger omgebouwd tot een trainingssimulator onder welk programma, waarbij de silhouet-tank uit de arcadeversie werd vervangen door realistischere voertuigmodellen en tactische trainingsscenario\'s werden toegevoegd?',
      ['De Bradley Trainer', 'De Abrams Simulator', 'Project Ironclad', 'De M1 Tactical Trainer'],
      0,
      'Het leger benaderde Atari omdat de vectorgrafische engine van Battlezone het perspectief van een tankschutter overtuigend simuleerde. Atari-ingenieurs pasten het aan om Bradley-schutters te trainen, met realistischer voertuigbesturing, wapensystemen en terrein.',
    ],
  ],
};
